...
const Tables = () => {
  ...
  const fetchTables = async () => {
    const url = 'https://rapiddb.link/select_from_table';
    const data = {
  ...
  const saveChanges = async () => {
    const url = 'https://rapiddb.link/insert_into_table';
  ...
  const deleteRow = async () => {
    ...
    const apiUrl = 'https://rapiddb.link/delete_from_table'; // Replace with your actual API endpoint
